          ...
          <div class="card-body">
            ...
            <form method="POST" enctype="multipart/form-data">
              ...
              <div class="mb-3">
                ...
                <input type="number" class="form-control" id="price" name="price" value="<?= $EditProduct['price'] ?>" oninput="this.value = 
 !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null">
              ...
              <div class="row">
                ...
                <div class="mb-3 col-lg-6">
                  ...
                  <input type="number" class="form-control" id="sale" name="sale" value="<?= $EditProduct['sale'] ?>" oninput="this.value = 
 !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null">
                </div>
              </div>
              <div class="mb-3">
