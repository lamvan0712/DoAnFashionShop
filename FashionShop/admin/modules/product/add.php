...
<div class="container-fluid">
            ...
            <form method="POST" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="mb-3 col-lg-4">
                  ...
                  <input type="number" class="form-control" id="number" name="number" oninput="this.value = 
 !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null">
                ...
                <div class="mb-3 col-lg-4">
                  ...
                  <input type="number" class="form-control" id="sale" name="sale" oninput="this.value = 
 !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null">
                </div>
              </div>
              <div class="mb-3">
