              ...
              <div class="product__item">
                <div class="product__item__pic set-bg" data-setbg="<?= uploads() ?>product/<?= $item['images'] ?>" style="background-image: url('<?= uploads() ?>product/<?= $item['images'] ?>');">
                  <ul class="product__hover">
                    <li><a href="san_pham.php?id=<?= $item['product_id'] ?>"><img src="<?= base_url() ?>public/frontend/img/icon/search.png" alt=""></a></li>
                  </ul>
                </div>
                <h6 class="pt-3"><a href="san_pham.php?id=<?= $item['product_id'] ?>" class="text-dark position-relative opacity-100 visible" style="opacity: 1;"><?= $item['name'] ?></a></h6>
