               ...
               <div class="product__details__text">
                  ...
                  <div class="product__details__option">
                     <div class="product__details__option__size">
                        ...
                        <label for="1Y">1Y
                           <input type="radio" id="1Y" name="size" class="size" value="1Y">
                        </label>
                        <label for="2Y">2Y
                           <input type="radio" id="2Y" name="size" class="size" value="2Y">
                        </label>
                        <label for="3Y">3Y
                           <input type="radio" id="3Y" name="size" class="size" value="3Y">
                        </label>
                        <label for="4Y">4Y
                           <input type="radio" id="4Y" name="size" class="size" value="4Y">
                        </label>
                        <label for="5Y">5Y
                           <input type="radio" id="5Y" naSe="size" class="size" value="5Y">
                        </label>
                     </div>
