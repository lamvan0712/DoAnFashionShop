...
<head>
	<meta charset="UTF-8">
	<meta name="description" content="Timman Template">
	<meta name="keywords" content="Timman, unica, creative, html">
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<meta http-equiv="X-UA-Compatible" content="ie=edge">
	<title>Timman Shop</title>
					...
					<div class="col-lg-6 col-md-5">
						<div class="header__top__right">
							<div class="header__top__links">
								...
								<?php else : ?>
									<a href="dang-nhap.php?path=<?php echo $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI'] ?>">Đăng nhập</a>
									<a href="dang-ki.php?path=<?php echo $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI'] ?>">Đăng ký</a>
								<?php endif ?>
								<a href="feedback.php">FAQs</a>
							</div>
						</div>
			...
			<div class="row">
				<div class="col-lg-3 col-md-3">
					<div class="header__logo">
						<a href="index.php"><img src="<?php echo base_url() ?>public/frontend/img/logo-2.png" alt="" width="196" height="50"></a>
					</div>
				</div>
